...
export const LESSONS: Lesson[] = [
  ...
  },
  {
    ...
    content: `
      <h3>מהו המדד?</h3>
      <p>מדד המחירים לצרכן הוא הכלי העיקרי למדידת האינפלציה. הוא בודק האם החיים בישראל התייקרו או הוזלו בחודש האחרון.</p>
      <br>
      <h3>מה יש ב"סל"?</h3>
      <p>הלשכה המרכזית לסטטיסטיקה (הלמ"ס) עוקבת אחרי מחירים של אלפי מוצרים ושירותים שמשפחה ממוצעת צורכת: מזון, דיור, תחבורה, חינוך, בריאות ועוד.</p>
      <br>
      <h3>למה הוא משמש?</h3>
      <p>1. <strong>עדכון שכר וקצבאות:</strong> כדי שערך הכסף של העובדים והגמלאים יישמר.<br>
      2. <strong>חוזים והלוואות:</strong> משכנתאות וחוזי שכירות רבים "צמודים למדד".<br>
      3. <strong>קביעת מדיניות:</strong> בנק ישראל מחליט על הריבית לפי השינויים במדד.</p>
    `
  },
  {
    id: 'bank-israel',
